...
public class MergeButton : MonoBehaviour
{
    ...
    private void OnMerge()
    {
        ...
        if(item1Name != "" && item2Name != "")
        {
            ...
            slot1.transform.GetChild(1).GetComponent<Text>().text = "";
            slot2.transform.GetChild(1).GetComponent<Text>().text = "";
            slot1.transform.GetComponent<Image>().sprite = Resources.Load<Sprite>("GUI_Parts/Gui_parts/Mini_frame0");
            slot2.transform.GetComponent<Image>().sprite = Resources.Load<Sprite>("GUI_Parts/Gui_parts/Mini_frame0");
